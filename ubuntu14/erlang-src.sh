...
./configure --prefix=${PREFIX} --enable-smp-support --enable-threads --enable-m64-build --enable-kernel-poll --enable-native-libs --enable-dtrace --disable-hipe --disable-sctp --without-javac
make
make install
